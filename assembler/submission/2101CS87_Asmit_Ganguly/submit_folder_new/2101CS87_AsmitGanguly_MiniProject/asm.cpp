...
// clearing up the labels on th commands
string labelspace(string s)
{
    int pos = s.find(':');
    if (pos != -1)
...
//function to check for the branching mechanism and ddecide for the branches twhat to do when so called for
void branchmech(ofstream &outputOFile, string str, int opcode)
{
...
//this decides for the label's address what to put as the address of the labels
void addressdecider(string str, bool &pol)
{
    stringstream ss(str);
    string word;
